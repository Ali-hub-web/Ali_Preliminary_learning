...
//void Cha_Get_Motor_Data(uint8_t i,uint8_t data[],motor_measure_t* Revice_Data)//?????????
//{
//	Revice_Data[i].last_ecd = motor_measure_t.;
//	Revice_Data[i].ecd = (data[0]<<8)|data[1];
//	Revice_Data[i].given_current = (data[4]<<8)|data[5];
//	Revice_Data[i].speed_rpm = (data[2]<<8)|data[3];
//	Revice_Data[i].temperate = data[6];
//}

//void Gim_Get_Motor_Data(uint8_t i,uint8_t data[],motor_measure_t* Revice_Data)//?????????
//{
//	Revice_Data[i].last_ecd = motor_measure_t.ecd;
//	Revice_Data[i].ecd = (data[0]<<8)|data[1];
//	Revice_Data[i].given_current = (data[4]<<8)|data[5];
//	Revice_Data[i].speed_rpm = (data[2]<<8)|data[3];
//	Revice_Data[i].temperate = data[6];
...
void CAN_cmd_gimbal(int16_t yaw, int16_t pitch, int16_t shoot, int16_t rev)
{
    ...
    gimbal_tx_message.StdId = 0x1ff;    //����������������������������������������������������������������������CAN_CHASSIS_ALL_ID
