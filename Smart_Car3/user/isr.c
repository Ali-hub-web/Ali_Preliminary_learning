...
IFX_INTERRUPT(cc60_pit_ch1_isr, 0, CCU6_0_CH1_ISR_PRIORITY)
{
   ...
   // Motor45_SetSpeed(3000);//right
    //Motor23_SetSpeed(3000);//left
...
//前车都+
   ...
   //Speed_Set(PWM_2, PWM_3, 1000);
    //后车
  //Speed_Set(PWM_2, PWM_5, 1000);
  //Speed_Set(PWM_3, PWM_5, 1000);

    //Motor_Control(10, 10);

    //the second varieable determine the main different speed
    //the third varieable determine the limitation of the different speed not to be too large
    //the first line of the series of data is combined a with b;the second line of the series of data is only b
   //50, 1.5, 28 ; 50, 1, 25   //
    //80 6 50  //60 3 30   //40 0.85 25   //50 1.3 25   //70, 7.5, 40   //80, 11, 55
    Differential_Gear(60, 3, 30);
    //Differential_Gear(80, 11, 55);
